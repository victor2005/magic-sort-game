...
console.log('🔧 Fixing Levels 41-60 - Solvability First...\n');
...
// Fix levels 41-60
console.log('🔧 Fixing levels 41-60 for solvability...\n');

let fixedCount = 0;

for (let i = 40; i <= 59; i++) { // Levels 41-60 (indices 40-59)
...
if (fixedCount > 0) {
  ...
  console.log('\n🎉 Levels 41-60 have been updated!');
