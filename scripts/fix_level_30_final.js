...
function createFinalLevel30() {
  console.log('🔧 Creating the final perfectly balanced Level 30...');
  ...
  // Each color appears exactly 6 times - carefully counted
  const newTubes = [
    ...
    ["#ff8a65", "#e57373", "#ff8a65", "#ba68c8", "#64b5f6", "#ffd54f"], // ff8:2, e57:1, ba6:1, 64b:1, ffd:1
    [] // Empty tube
  ];
  ...
  console.log('✅ Final Level 30 has been created and saved!');
