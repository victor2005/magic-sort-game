...
// Actually reduce empty tubes by modifying tube arrays
function actuallyReduceEmptyTubes() {
  console.log('Actually reducing empty tubes by modifying tube arrays...');
  ...
  levels.forEach((level, levelIndex) => {
    ...
    // If we have too many empty tubes, actually reduce them
  ...
  console.log(`✅ Empty tubes correctly reduced: ${emptyTubesCorrect ? 'YES' : 'NO'}`);
  
  if (allPerfect && noConflicts && frozenPartial && emptyTubesCorrect) {
    ...
    console.log('   • Empty tubes actually reduced');
