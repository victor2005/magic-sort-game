...
console.log('🔧 Fixing Levels 31-40 - Solvability First...\n');
...
// Fix levels 31-40
console.log('🔧 Fixing levels 31-40 for solvability...\n');

let fixedCount = 0;

for (let i = 30; i <= 39; i++) { // Levels 31-40 (indices 30-39)
...
if (fixedCount > 0) {
  ...
  console.log('\n🎉 Levels 31-40 have been updated!');
