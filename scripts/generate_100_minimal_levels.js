...
// Generate a level with minimal empty tubes
function generateMinimalLevel(levelIndex) {
...
// Generate 100 minimal levels
function generate100MinimalLevels() {
  console.log('Generating 100 levels with minimal empty tubes...');
  ...
  for (let i = 0; i < 100; i++) {
    ...
    const levelConfig = generateMinimalLevel(i);
  ...
  if (allPerfect && noConflicts && frozenPartial && emptyTubesMinimal) {
    console.log('\n🎉 SUCCESS! Generated 100 challenging levels:');
